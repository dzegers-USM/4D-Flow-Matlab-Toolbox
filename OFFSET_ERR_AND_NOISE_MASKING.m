...
% Last Modified by GUIDE v2.5 02-Oct-2024 16:27:38
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    elseif handles.id_variable==2
        ...
        set(handles.text6,'String',sprintf('%.0f%%',100 * value))
        pp=1/100;
        slider_step(1) = pp;
        slider_step(2) = pp;
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    if handles.id_variable==2
        set(handles.text6, 'String', sprintf('%.0f%%',100 * get(hObject,'Value')));
