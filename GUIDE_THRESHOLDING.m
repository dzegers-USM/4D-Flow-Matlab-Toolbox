...
handles.output = hObject;
    ...
    if handles.id == 1
        ...
        set(handles.text14,'String',['Slice: ',num2str(handles.slider_axes1),' / ',num2str(handles.c)])
...
function pushbutton1_Callback(hObject, eventdata, handles)
        ...
        elseif handles.view_sac == 2;
            ...
            axis off
            daspect([1 1 1])
            set(handles.text14,'String',['Slice: ',num2str(handles.slider_axes2),' / ',num2str(handles.b)])
        elseif handles.view_sac == 3;
            ...
            axis off
            daspect([1 1 1])
            set(handles.text14,'String',['Slice: ',num2str(handles.slider_axes3),' / ',num2str(handles.a)])
        end
