...
%                 set(himage, 'AlphaData', cdata);
                ...
                set(handles.text1,'String',['Slice: ',num2str(handles.slider_axes1),' / ',num2str(handles.c)]);
...
%                 set(himage, 'AlphaData', cdata);
                ...
                set(handles.text1,'String',['Slice: ',num2str(handles.slider_axes1),' / ',num2str(handles.b)]);
...
%                 set(himage, 'AlphaData', cdata);
                ...
                set(handles.text1,'String',['Slice: ',num2str(handles.slider_axes1),' / ',num2str(handles.a)]);
...
uiwait(handles.figure1); % POSIBLE CAMBIO figure1 por GUIDE_FLOW JSOTELO
...
%         
        ...
        handles.peak_flow = I;
        handles.area_flow = area; % Julio Sotelo
        % Julio Sotelo
%         %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
mean_velocity = squeeze(handles.mean_velocity);
area_flow = ones(size(mean_velocity)).*handles.area_flow;
area_flow = area_flow./100;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
VV = {'Time [s]';...
      'Flow [ml/s]';...
      'Net Flow [ml]';...
...
MM = [handles.time';handles.flow';handles.net_flow';mean_velocity';handles.max_velocity';handles.min_velocity';area_flow'];
TT = table(VV,MM);
